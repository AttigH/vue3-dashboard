<template>
  <a-modal :title="$t('account.selectSkillAndInterst')" :open="visible" :confirm-loading="confirmLoading" @ok="onOk" :closable="false" destroyOnClose :keyboard="false" width="700px">
    <a-button slot="footer" @click="onOk" type="primary" :disabled="disabledBtn">{{ $t('account.saveAndClose') }}</a-button>
