...
for (let i = 0; i < 7; i++) {
  rankList.push({
    name: 'Egret Island Store No.' + (i + 1),
    total: 1234.56 - i * 100
  })
}
...
const sourceData = [
  { item: 'Home appliances', count: 32.2 },
  { item: 'Drinks', count: 21 },
  { item: 'Personal Health', count: 17 },
  { item: 'Clothing and Bags', count: 13 },
  { item: 'Maternal and Child Products', count: 9 },
