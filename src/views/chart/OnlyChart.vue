<template>
  <div class="OnlyChart">
    <a-button size="small" type="primary" @click="showExamplesModal = true" id="btn">Open Legend</a-button>
    <MakeChart :cellSize="cellSize" :showExamplesModal="showExamplesModal" v-if="showMakeChart" @closeModal="onCloseModal" prevElName="#btn" />
  </div>
</template>
