<template>
  <div class="Logicflow">
    <a-alert message="A plug-in that can display flow charts, based on Didi's logicflow, encapsulated into a vue3 version. Clicking any node can output all its parent names." />
    <a-button type="primary" style="margin: 10px 0" @click="onSaveFlowData">Save</a-button>
